  ...
  return (
    <>
      <div
        ...
        className="flex items-center gap-2 text-white bg-indigo-600 px-4 py-2 rounded-xl shadow-md hover:bg-indigo-700 transition duration-300 cursor-pointer"
      >
      ...
      {isReviewing && (
        <div
          ...
          role="dialog"
        >
          <div className="bg-white shadow-lg rounded-xl w-full max-w-lg mx-4 p-6 transform transition-all ease-in-out duration-300 scale-100 hover:scale-105">
              ...
              <div className="flex gap-1 justify-center mb-6">
                {[1, 2, 3, 4, 5].map((star) => (
                  <div
                    ...
                    className="text-yellow-500 hover:text-yellow-400 transition duration-200 cursor-pointer"
                  >
                    {hoveredRating !== null ? (
                      hoveredRating >= star ? <BsStarFill size={24} /> : <BsStar size={24} />
                    ) : (
                      formData.rating >= star ? <BsStarFill size={24} /> : <BsStar size={24} />
                    )}
                  </div>
                ))}
              </div>
            ...
            <div className="flex justify-between gap-4">
              <button
                onClick={addReview}
                className="flex-1 bg-indigo-600 text-white py-2 px-4 rounded-xl shadow-md hover:bg-indigo-700 transition duration-200"
              >
                Submit Review
              </button>
              <button
                ...
                className="flex-1 bg-gray-500 text-white py-2 px-4 rounded-xl shadow-md hover:bg-gray-600 transition duration-200"
              >
                Cancel
              </button>
            </div>
