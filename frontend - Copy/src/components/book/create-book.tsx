...
export function CreateBook() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <button
  onClick={openModal}
  className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-4 py-2 rounded-md shadow-sm hover:from-indigo-600 hover:to-blue-500 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-300"
>
  Create Book
</button>
      <CreateBookModal
