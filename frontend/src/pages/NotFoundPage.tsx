  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col">
      ...
      <main className="flex-1 max-w-2xl w-full mx-auto px-4 py-20 flex flex-col items-center justify-center text-center">
        <div className="w-24 h-24 rounded-3xl bg-indigo-950/70 border border-indigo-700/80 flex items-center justify-center text-indigo-400 mb-6 shadow-2xl shadow-indigo-600/20 animate-fade-in">
          <BookX className="w-12 h-12" />
        </div>

        <span className="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-rose-950/80 text-rose-400 border border-rose-800/80 mb-3">
          404 - Chapter Not Found
        </span>

        <h1 className="text-3xl sm:text-5xl font-black text-slate-100 tracking-tight mb-4">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <Link
            to="/"
            className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-slate-900 hover:bg-slate-800 text-slate-300 font-bold text-sm border border-slate-800 transition-all flex items-center justify-center gap-2"
          >
