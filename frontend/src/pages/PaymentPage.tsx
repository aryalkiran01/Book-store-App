  ...
  if (!orderDetails) {
    return (
      <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-6">
        ...
        <p className="text-slate-400">Loading order checkout...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col selection:bg-indigo-500 selection:text-white">
      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-800">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-white flex items-center gap-3">
              <CreditCard className="text-indigo-400" size={26} /> Payment Method
            </h1>
          </div>
        ...
        {errorMsg && (
          <div className="mb-6 bg-rose-950/80 border border-rose-800/80 rounded-2xl p-4 text-rose-300 text-xs flex items-center gap-3">
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-purple-900/40 border border-purple-700/60 flex items-center justify-center font-black text-purple-300 text-sm">
                      K
                    </div>
                    <div>
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-emerald-900/40 border border-emerald-700/60 flex items-center justify-center text-emerald-300">
                      <Truck size={20} />
                    </div>
                    <div>
                      <span className="font-bold text-white text-sm">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-amber-900/40 border border-amber-700/60 flex items-center justify-center text-amber-300">
