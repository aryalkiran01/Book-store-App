/**
 * Comprehensive Final End-to-End Quality Control & Security Audit Test Suite
 * Tests all flows from Phase 17 & Phase 18
 */
import mongoose from "mongoose";
import { UserModel } from "../src/modules/auth/model.ts";
import { BookModel } from "../src/modules/book/model.ts";
import { ReviewModel } from "../src/modules/review/model.ts";
import { OrderModel } from "../src/modules/order/model.ts";
import {
  createUserService,
  loginService,
  getUserById,
...
import {
  ...
  cancelOrderService,
  validateCartService,
} from "../src/modules/order/service.ts";
import {
  createReviewService,
  ...
  reportReviewService,
} from "../src/modules/review/service.ts";
import {
...
} from "../src/modules/admin/service.ts";
import {
  addBookService,
  getBooksService,
  getBookByIdService,
...
} from "../src/modules/book/service.ts";
import { verifyToken, generateToken } from "../src/utils/auth.ts";
import { sanitizeNoSqlInput, sanitizeString } from "../src/utils/security.ts";
...
async function runAudit() {
  ...
  let sampleBook, createdOrder, sampleReview;
